...
현재 운영 블로그: `llmenginehistory` (서울/경기/인천 청약 인사이트, https://llmenginehistory.tistory.com)
...
```
[수집] lh_scraper.py / applyhome_scraper.py
...
├── guides/            # supply_type별 가이드 (sale.md, happy_housing.md 등)
└── tasks/
    ├── planned/       # 기획 완료, 집필 대기
    ├── writing/       # 집필 중
    ├── published/     # 발행 완료
